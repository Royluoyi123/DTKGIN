...
def parse_args():
    ...
    # ===== dataset ===== #
    parser.add_argument("--dataset", nargs="?", default="Y08/warm_start_1_10", help="Choose a dataset:[Y08,luodatatset]")
    parser.add_argument(
    ...
    parser.add_argument('--Ks', nargs='?', default='[10]', help='Output sizes of every layer')
    parser.add_argument('--test_flag', nargs='?', default='part',
                        help='Specify the test type from {part, full}, indicating whether the reference is done in mini-batch')
    parser.add_argument("--n_factors", type=int, default=8, help="number of latent factor for user favour")
